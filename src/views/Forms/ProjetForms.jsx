                        ...
                        <Col md={12}>
                            <Form horizontal>
                                <Card
                                    ...
                                    content={
                                        <div>
                                            <FormGroup controlId="formHorizontalRequiredText">
                                                ...
                                                <Col sm={6}>
                                                    <FormControl type="text" name="nom" onChange={(event) => {
                                            ...
                                            <FormGroup controlId="formHorizontalNumber">
                                                ...
                                                <Col sm={6}>
                                                    <FormControl type="text" name="nomProjet" onChange={(event) => {
                                    ...
                                    ftTextCenter
                                    legend={
                                        <Button fill bsStyle="info" type="submit" onClick={this.handleTypeValidation.bind(this)}>Ajouter Projet</Button>
                                    }
                                />
                            </Form>
                        </Col>

                        ...
                        <Col md={12}>
                            <Form horizontal action='google.com'>
                                <Card
                                    ...
                                    ftTextCenter
                                    legend={
                                        <NavLink to={{pathname:"/tables/ListeAleatoire",state:{classe:"3A22",idProjet:"5e7e2af2b5e8642830f635db"}}}><Button fill bsStyle="info" type="submit" onClick={this.formerEquipe.bind(this)}>Valider</Button></NavLink>
                                    }
                                />
                            </Form>
                        </Col>

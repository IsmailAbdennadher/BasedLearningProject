...
var dashRoutes = [
    ...
    { collapse: true, path: "/forms", name: "Forms", state: "openForms", icon: "pe-7s-note2", views:
        [{ path: "/forms/projet", name: "Ajouter Projet", mini: "AP", component: ProjetForms },
        { path: "/forms/Listeprojets", name: "Liste Projets", mini: "LP", component: ListeProjets },
        ...
        { path: "/ChoixEquipeSujets", name: "Choix Sujets", mini: "AS", component: ChoixEquipeSujets },
    ...
    { collapse: true, path: "/tables", name: "Tables", state: "openTables", icon: "pe-7s-news-paper", views:
        [{ path: "/tables/EquipesChoix", name: "Choix Equipes", mini: "LA", component: EquipesChoixTable },
